...
GenerateMipsPSO::GenerateMipsPSO()
{
	...
	CD3DX12_STATIC_SAMPLER_DESC linearSamplerDesc(
		0,
	...
	CD3DX12_VERSIONED_ROOT_SIGNATURE_DESC rootSignatureDesc(GenerateMips::NumRootParameters, rootParameters, 1, &linearSamplerDesc);
