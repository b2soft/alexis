...
namespace alexis
{
	...
	DescriptorAllocation DescriptorAllocatorPage::Allocate(uint32_t numDescriptors)
	{
		...
		auto smallesBlockIt = m_freeListBySize.lower_bound(numDescriptors);
		if (smallesBlockIt == m_freeListBySize.end())
		{
